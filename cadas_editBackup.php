...
<div class="d-flex justify-content-center">
                ...
                <?php if (isset($get['edit']) && $get['edit'] == 1) { ?>
                  ...
                  <div id="ed" >
                    ...
                    ?>
                     <select name="id_categoria" id="id_categoria" form="form2">
                    ...
                    while ($list2 = $select_edit2->fetch_assoc()) {
                        ...
                        ?>
                        <option
                          value="<?php echo$list2['id']?>" <?php echo $selected; ?>>
                         <?php echo$list2['categoria']?>
                        </option><?php 
                    }
                    ?>
                    </select>
                    ...
                    <input type="text" name="telefone" id="telefoneE" 
                    value="<?php echo $list['telefone'] ?>">
             ...
             <div id="criador" >
                ...
                while ($list = $select->fetch_assoc()) {
                    ...
                    while ($list2 = $select_edit2->fetch_assoc()) {
                        ...
                        ?><option value="<?php echo$list2['id']?>" <?php echo $selected;?>>
                        <?php echo$list2['categoria']?></option>
                        <?php 
                    }
                    ?>
                    </select>
